var SnailBait = function () {
   ...
   this.runBehavior = {
      ...
      execute: function (sprite, 
         ...
         if (sprite.runAnimationRate === 0) { //Breaks out of function if runner is not moving
            return;
         }
...
SnailBait.prototype = {
         ...
         snail = new Sprite('snail',
                            ...
                            [ this.paceBehavior,
                              ...
                              new CycleBehavior(300,  // 300ms per image
                                                1000) // Changed this to a 1 second interlude for problem #2.
                            ]);
   ...
   drawSprites: function() {
      var sprite, leftEdge, rightEdge, ptrack;

      //this.isRunnerOnPlatform = false;
      ...
      for (var i=0; i < this.sprites.length; ++i) {
         ...
         if (sprite.visible && this.isSpriteInView(sprite)) {
            ...
            if(sprite.type === 'platform' && sprite.track === 1){
               leftEdge = sprite.left + sprite.hOffset;
               rightEdge = sprite.left + sprite.width + sprite.hOffset;
               

               if(leftEdge < 50 && rightEdge > 100){ //Checks if platform is beneath the runner
                  this.isRunnerOnPlatform = true;
            ...
            if(sprite.type === 'runner'){
               if(this.isRunnerOnPlatform == false){
